## Clock signal
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { XCLK }]
create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports { XCLK }]

## Reset (Active Low) - Mapped to XRES
set_property -dict { PACKAGE_PIN C12   IOSTANDARD LVCMOS33 } [get_ports { XRES }]
...
## Switches (Used for SW input mapped to IPORT)
